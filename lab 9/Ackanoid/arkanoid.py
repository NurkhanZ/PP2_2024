...
while not done:
    while main_menu:
        screen.fill(MAINMENU)
        for event in pygame.event.get():
            pressedkey = pygame.key.get_pressed()
            if event.type == pygame.QUIT:
                exit_game()
            screen.blit(font.render('Arkanoid', True, BLACK), (W // 2 - 95, H // 2 - 100))
            screen.blit(font.render('Press Space to play', True, BLACK), (W // 2 - 175, H // 2 + 50))
            pygame.display.flip()
    ...
    if not paused:
        ...
        screen.blit(font.render('Press ESC to pause', True, WHITE), (800, 0))
        ...
        if not settings:
            ...
            screen.blit(font.render('Pause', True, BLACK), (W // 2 - 60, H // 2 - 150))
            screen.blit(font.render('Press S to enter settings', True, BLACK), (W // 2 - 225, H // 2 - 50))
            screen.blit(font.render('Press ESC to return to game', True, BLACK), (W // 2 - 225, H // 2 + 50))
        else:
            screen.blit(transparent_surface, (0, 0))
            screen.blit(font.render('Settings', True, BLACK), (W // 2 - 75, H // 2 - 150))
            screen.blit(font.render('Press B for bigger ball', True, BLACK), (W // 2 - 225, H // 2 - 50))
            screen.blit(font.render('Press P for wide paddle', True, BLACK), (W // 2 - 225, H // 2))
            screen.blit(font.render('Press D to return to default', True, BLACK), (W // 2 - 225, H // 2 + 50))
            screen.blit(font.render('Press S to exit settings', True, BLACK), (W // 2 - 225, H // 2 + 150))
